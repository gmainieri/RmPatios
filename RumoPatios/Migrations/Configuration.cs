    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RumoPatios.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(RumoPatios.Models.ApplicationDbContext context)
        {
            ...
            context.Chegadas.AddOrUpdate(
                x => x.prefixo,
                new Chegada { prefixo = "D34", HorarioChegada = DateTime.ParseExact("16/08/2017 04:00", formato, cultura), QtdeVagoesCarregados = 91, QtdeVagoesVazio = 0 },
                new Chegada { prefixo = "D02", HorarioChegada = DateTime.ParseExact("16/08/2017 07:00", formato, cultura), QtdeVagoesCarregados = 83, QtdeVagoesVazio = 0 },
                new Chegada { prefixo = "D36", HorarioChegada = DateTime.ParseExact("16/08/2017 10:00", formato, cultura), QtdeVagoesCarregados = 80, QtdeVagoesVazio = 0 },
                new Chegada { prefixo = "D38", HorarioChegada = DateTime.ParseExact("16/08/2017 11:00", formato, cultura), QtdeVagoesCarregados = 78, QtdeVagoesVazio = 0 },
                new Chegada { prefixo = "L04", HorarioChegada = DateTime.ParseExact("16/08/2017 13:00", formato, cultura), QtdeVagoesCarregados = 40, QtdeVagoesVazio = 20 },
                new Chegada { prefixo = "D26", HorarioChegada = DateTime.ParseExact("16/08/2017 15:00", formato, cultura), QtdeVagoesCarregados = 79, QtdeVagoesVazio = 0 },
                new Chegada { prefixo = "K70", HorarioChegada = DateTime.ParseExact("16/08/2017 20:00", formato, cultura), QtdeVagoesCarregados = 80, QtdeVagoesVazio = 0 }
                );

            context.Partidas.AddOrUpdate(
                x => x.prefixo,
                new Partida { prefixo = "M33", HorarioPartida = DateTime.ParseExact("16/08/2017 13:00", formato, cultura), QtdeVagoesCarregados = 0, QtdeVagoesVazio = 40 },
                new Partida { prefixo = "M31", HorarioPartida = DateTime.ParseExact("16/08/2017 18:00", formato, cultura), QtdeVagoesCarregados = 60, QtdeVagoesVazio = 20 },
                new Partida { prefixo = "L05", HorarioPartida = DateTime.ParseExact("16/08/2017 19:30", formato, cultura), QtdeVagoesCarregados = 70, QtdeVagoesVazio = 10 },
                new Partida { prefixo = "M05", HorarioPartida = DateTime.ParseExact("16/08/2017 22:00", formato, cultura), QtdeVagoesCarregados = 40, QtdeVagoesVazio = 40 },
                new Partida { prefixo = "L07", HorarioPartida = DateTime.ParseExact("16/08/2017 23:30", formato, cultura), QtdeVagoesCarregados = 0, QtdeVagoesVazio = 40 }
                );
            ...
            context.Carregamentos.AddOrUpdate(
                ...
                new Carregamento { LinhaID = 4, Cliente = "Ipiranga", Produto = "Oleo vegetal", QtdeVagoes = 70, HorarioCarregamento = DateTime.ParseExact("16/08/2017 08:00", formato, cultura) },
                new Carregamento { LinhaID = 1, Cliente = "Cargill", Produto = "Fertilizante", QtdeVagoes = 40, HorarioCarregamento = DateTime.ParseExact("16/08/2017 14:00", formato, cultura) },
                new Carregamento { LinhaID = 3, Cliente = "Bunge", Produto = "Fertilizante", QtdeVagoes = 30, HorarioCarregamento = DateTime.ParseExact("16/08/2017 15:30", formato, cultura) }
                );
